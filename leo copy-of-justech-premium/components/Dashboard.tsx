...
const Dashboard: React.FC<DashboardProps> = ({ onChangeView, onSaveCompanyContext }) => {
  ...
  return (
    <div className="p-8 ml-64 min-h-screen bg-slate-50 dark:bg-slate-900 animate-in fade-in duration-500 transition-colors duration-300">
      ...
      <div className={`bg-white dark:bg-legal-800 rounded-xl p-8 mb-10 transition-all border shadow-sm ${empresaAtiva ? 'border-legal-gold ring-2 ring-legal-gold/20' : 'border-gray-200 dark:border-legal-700'}`}>
