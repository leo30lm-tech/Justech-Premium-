...
import ContractModule from './ContractModule'; // Este está na raiz segundo a lista
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen relative transition-colors duration-300 ${theme === 'dark' ? 'bg-legal-900' : 'bg-slate-50'}`}>
      ...
      <div className={`transition-all duration-300 ${mobileMenuOpen ? 'opacity-50 pointer-events-none md:opacity-100' : ''} md:ml-0`}>
