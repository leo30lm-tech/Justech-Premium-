...
import { LayoutDashboard, Scale, Settings, LogOut, FileText, UserCircle, Calculator, Gavel } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <div className="w-64 h-screen bg-legal-900 dark:bg-black text-white flex flex-col fixed left-0 top-0 shadow-xl z-20 border-r border-legal-800 dark:border-gray-800 transition-colors duration-300">
      <div className="p-6 border-b border-legal-800 dark:border-gray-800 flex items-center space-x-3">
